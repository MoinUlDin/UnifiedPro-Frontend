                ...
                <ul className="horizontal-menu hidden py-1.5 font-semibold px-6 lg:space-x-1.5 xl:space-x-8 rtl:space-x-reverse bg-white border-t border-[#ebedf2] dark:border-[#191e3a] dark:bg-black text-black dark:text-white-dark">
                    ...
                    <li className="menu nav-item relative">
                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink to="/hcims-dashboard">{t('Dashboard')}</NavLink>
                            </li>
                            <li>
                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                <IconListCheck className="shrink-0" />
                                <span className="px-1">{t('Tasks')}</span>
                            </div>
                            <div className="right_arrow">
                                <IconCaretDown />
                            </div>
                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1">{t('Routines')}</span>
                            </div>
                            <div className="right_arrow">
                                <IconCaretDown />
                            </div>
                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1">{t('Evaluations')}</span>
                            </div>
                            <div className="right_arrow">
                                <IconCaretDown />
                            </div>
                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1">{t('Training Section')}</span>
                            </div>
                            <div className="right_arrow">
                                <IconCaretDown />
                            </div>
