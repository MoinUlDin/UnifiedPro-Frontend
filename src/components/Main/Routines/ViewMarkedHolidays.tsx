...
const ViewMarkedHolidays = () => {
  ...
  const holidays: Holiday[] = [
    { date: "Nov. 6, 2024", type: "Public Holiday", remarks: "Independence Day" },
    { date: "Nov. 10, 2024", type: "Religious Holiday", remarks: "Christmas Day" },
    { date: "Dec. 25, 2024", type: "Public Holiday", remarks: "New Year's Day" },
    { date: "Jan. 1, 2025", type: "Special Holiday", remarks: "Foundation Day" },
  ];
              ...
              {holidays.map((holiday, idx) => (
                <tr key={idx} className="group border-b border-[#e0e6ed] dark:border-[#1b2e4b] hover:bg-[#f7f7f7] dark:hover:bg-[#1a2941]">
                  ...
                  <td className="px-4 py-3 text-sm">
                    <span className={`rounded-full px-2.5 py-0.5 text-xs font-medium ${getStatusColor(holiday.type)}`}>
                      {holiday.type}
                    </span>
                  </td>
