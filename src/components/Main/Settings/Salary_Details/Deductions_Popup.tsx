...
const Deductions_Popup = ({ closeModal }: { closeModal: () => void }) => {
    ...
    const Submit=async(e: any)=>{
        e.preventDefault();
        try{
            let response=await axios.post("https://success365-backend-86f1c1-145db9-65-108-245-140.traefik.me/routine-tasks/deduction/",params,
                {
                    headers:{
                                ...
                                <div className="p-5">
                                    <form>
                                        ...
                                        <div className="mb-5">
                                            ...
                                            <input id="percentage" type="number" placeholder="" className="form-input" value={params.percentage} onChange={(e) => changeValue(e)} />
                                        </div>
...
export default Deductions_Popup;
