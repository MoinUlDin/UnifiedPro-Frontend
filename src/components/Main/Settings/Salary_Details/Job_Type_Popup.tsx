...
const Job_Type_Popup = ({ closeModal }: { closeModal: () => void }) => {
                                ...
                                <div className="p-5">
                                    <form>
                                        ...
                                        <div className="flex justify-end items-center mt-8">
                                            ...
                                            <button type="submit" onClick={onSubmit} className="btn btn-primary ltr:ml-4 rtl:mr-4">
                                                Create
                                            </button>
                                        </div>
                                    </form>
