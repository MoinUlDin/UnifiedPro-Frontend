...
const Department_Goals_List_Popup = ({ closeModal }: { closeModal: () => void }) => {
                    ...
                    <div className="flex min-h-full items-center justify-center px-4 py-8">
                        ...
                        >
                            <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-xl text-black dark:text-white-dark">
                                ...
                                <div className="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]">Create Departmental Goal</div>
                                <div className="p-5">
                                    <form>
                                        <div className="mb-5">
                                        ...
                                        <div className="mb-5">
                                            ...
                                            <div className="relative">
                                                <select id="Company_Goal" className="form-input appearance-none pr-10" value={params.Company_Goal} onChange={(e) => changeValue(e)}>
                                                    <option value="" disabled>
                                                        --------
                                                    </option>
                                                    <option value="Session 1">Technical</option>
                                        ...
                                        <div className="mb-5">
                                            <label htmlFor="Performance_Year">Performance Year</label>
                                            <div className="relative">
                                                <select id="Performance_Year" className="form-input appearance-none pr-10" value={params.Performance_Year} onChange={(e) => changeValue(e)}>
                                                    <option value="" disabled>
                                                        --------
                                                    </option>
                                                    <option value="Session 1">Technical</option>
...
export default Department_Goals_List_Popup;