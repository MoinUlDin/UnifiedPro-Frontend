...
const Departmental_Session_Goals_Popup = ({ closeModal }: { closeModal: () => void }) => {
                    ...
                    <div className="flex min-h-full items-center justify-center px-4 py-8">
                        ...
                        >
                            <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-xl text-black dark:text-white-dark">
                                ...
                                <div className="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]">Create Departmental Session Goal</div>
                                <div className="p-5">
                                    <form>
                                        <div className="mb-5">
