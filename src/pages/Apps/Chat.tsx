            ...
            <div className="pt-5">
                <div className="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-5 mb-5">
                    <div className="panel">
                        ...
                        <div className="mb-5">
                            <div className="flex flex-col justify-center items-center">
                                ...
                                <p className="font-semibold text-primary text-xl">Sharyar Nisar</p>
                            </div>
                            <ul className="mt-5 flex flex-col max-w-[160px] m-auto space-y-4 font-semibold text-white-dark">
                                ...
                                <li>
                                    <button className="flex items-center gap-2">
                                        ...
                                        <span className="text-primary truncate">sharyar@gmail.com</span>
                                    </button>
                                </li>
                                <li className="flex items-center gap-2">
                                    <IconPhone />
                    ...
                    <div className="panel lg:col-span-2 xl:col-span-2">
                        ...
                        </div>  <div className="panel lg:col-span-2 xl:col-span-2">
                            <div className="flex items-center justify-between">
                                <div>
