                    ...
                    >
                        <div className="space-y-6 max-w-xl">
                            ...
                            <p className="text-xl text-gray-300 leading-relaxed">
                                Experience the future of workforce management with our AI-powered platform
                            </p>
                        </div>
                    ...
                    <form onSubmit={submitForm} className="space-y-8">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <div className="absolute inset-0 rounded-2xl transition-opacity duration-200 pointer-events-none">
                                        <div className="absolute inset-[-1px] rounded-2xl bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 opacity-0 group-focus-within:opacity-100" style={{ padding: '1px' }}>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center">
                                ...
                                />
                                <label htmlFor="remember" className={`ml-2 text-sm ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>Remember me</label>
                            </div>
                            <Link
                                to="/forgot-password"
